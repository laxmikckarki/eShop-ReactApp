    ...
    return (
      <div className="home">
        ...
        <div className='home_row'>
            <Product title="Bennett Mystic 15.6 inch Laptop Shoulder Messenger Sling Office Bag, Water Repellent Fabric for Men and Women(Blue)" 
            price={11.96}
            rating={5}
        image="https://images-na.ssl-images-amazon.com/images/I/71mEsHyzSCL._SL1000_.jpg"
            />
            <Product title="IFB 30 L Convection Microwave Oven (30BRC2, Black, With Starter Kit)"
            price={239}
            rating={4}
        ...
        <div className='home_row'>
            <Product title="All the Light we Cannot See: The Breathtaking World Wide Bestseller Paperback"
            price={199.99}
            rating={2}
